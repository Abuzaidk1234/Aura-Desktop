import os
import ctypes
from ctypes import c_int, POINTER, Structure, sizeof
from PyQt6.QtCore import QObject, Qt, QTimer
from PyQt6.QtGui import QColor
from PyQt6.QtWidgets import (
    QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QFrame, QWidget, QGraphicsDropShadowEffect
)
...
class PomodoroWindow(QWidget):
    def __init__(self, comm, main_app=None):
        ...
        self.setStyleSheet("""
            QFrame#container {
                background-color: rgba(20, 20, 25, 60); /* Highly transparent to show OS blur */
                border-radius: 16px;
        ...
        self.min_btn.setObjectName("closeBtn")
...
class ShutdownOSDWindow(QWidget):
    ...
    def abort_shutdown(self):
        ...
        if self.main_app:
            self.main_app.comm.show_subtitle.emit("System shutdown aborted. Standing by.")
            self.main_app.speak("System shutdown aborted. Standing by.", return_to_idle=True)
